...
public class FactionRemoveArgument extends CommandArgument {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (plugin.getFactionManager().removeFaction(faction, sender)) {
            Command.broadcastCommandMessage(sender, ChatColor.GRAY + "Disbanded faction " + faction.getName() + ChatColor.GRAY + '.');
        }
    ...
    private static class RemoveAllPrompt extends StringPrompt {
        ...
        public String getPromptText(ConversationContext context) {
            return ChatColor.GRAY + "Are you sure you want to do this? " + ChatColor.RED + ChatColor.BOLD + "All factions" + ChatColor.GRAY + " will be cleared. " + "Type " + ChatColor.GREEN
                    + "yes" + ChatColor.GRAY + " to confirm or " + ChatColor.RED + "no" + ChatColor.GRAY + " to deny.";
        }
