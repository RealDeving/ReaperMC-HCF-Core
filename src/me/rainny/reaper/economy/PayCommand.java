...
public class PayCommand implements CommandExecutor, TabCompleter {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        targetPlayer.sendMessage(ChatColor.GRAY + sender.getName() + " has sent you " + ChatColor.GOLD + EconomyManager.ECONOMY_SYMBOL + amount + ChatColor.GRAY + '.');
        sender.sendMessage(ChatColor.GRAY + "You have sent " + ChatColor.GOLD + EconomyManager.ECONOMY_SYMBOL + amount + ChatColor.GRAY + " to " + target.getName() + '.');
        return true;
    }
