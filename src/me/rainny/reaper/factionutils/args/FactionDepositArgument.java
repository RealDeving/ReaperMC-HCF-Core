...
public class FactionDepositArgument extends CommandArgument {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        playerFaction.broadcast(Relation.MEMBER.toChatColour() + playerFaction.getMember(player).getRole().getAstrix() + sender.getName() + ChatColor.GRAY + " has deposited " + ChatColor.GREEN
                + EconomyManager.ECONOMY_SYMBOL + JavaUtils.format(amount) + ChatColor.GRAY + " into the faction balance.");
