...
public class FactionWithdrawArgument extends CommandArgument {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        playerFaction.broadcast(SettingsYML.TEAMMATE_COLOUR + factionMember.getRole().getAstrix() + sender.getName() + ChatColor.GRAY + " has withdrew " + ChatColor.RED
                + EconomyManager.ECONOMY_SYMBOL + JavaUtils.format(amount) + ChatColor.GRAY + " from the faction balance.");
