package me.rainny.reaper.timer.args;
...
import me.rainny.reaper.listener.UUIDFetcher;
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        new BukkitRunnable() {
            ...
            public void run() {
                ...
                sender.sendMessage(ChatColor.GRAY + args[2] + " has timer " + playerTimer.getName() + " for another " + DurationFormatUtils.formatDurationWords(remaining, true, true));
            }
