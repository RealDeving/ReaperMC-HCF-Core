package me.rainny.reaper.kothevent.args;
...
public class KothSetCapDelayArgument extends CommandArgument {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        sender.sendMessage(ChatColor.GRAY + "Set the capture delay of KOTH arena " + ChatColor.WHITE + kothFaction.getDisplayName(sender) + ChatColor.GRAY + " to " + ChatColor.WHITE
                + DurationFormatUtils.formatDurationWords(duration, true, true) + ChatColor.WHITE + '.');
        Bukkit.broadcastMessage(ChatColor.GRAY + "The capture time of " + ChatColor.RED + kothFaction.getDisplayName(sender) + ChatColor.GRAY + " has been set to " + ChatColor.RED
