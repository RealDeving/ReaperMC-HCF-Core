package me.rainny.reaper.endoftheworld;
...
public class EotwCommand implements CommandExecutor, TabCompleter {
    ...
    private static final class EotwPrompt extends StringPrompt {
        ...
        public String getPromptText(ConversationContext context) {
            return ChatColor.GRAY + "Are you sure you want to do this? The server will be in EOTW mode, If EOTW mode is active, all claims whilst making Spawn a KOTH. " + "You will still have "
                    + EotwHandler.EOTW_WARMUP_WAIT_SECONDS + " seconds to cancel this using the same command though. " + "Type " + ChatColor.GREEN + "yes" + ChatColor.GRAY + " to confirm or "
                    + ChatColor.RED + "no" + ChatColor.GRAY + " to deny.";
        }
