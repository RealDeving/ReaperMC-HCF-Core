...
public class ConquestFaction extends CapturableFaction implements ConfigurationSerializable {
    ...
    public enum ConquestZone {
        ...
        RED(ChatColor.RED, "Red"), BLUE(ChatColor.AQUA, "Blue"), YELLOW(ChatColor.GRAY, "Yellow"), GREEN(ChatColor.GREEN, "Green");
    ...
    public void printDetails(CommandSender sender) {
        ...
        for (Claim claim : claims) {
            ...
            sender.sendMessage(ChatColor.GRAY + "  Location: " + ChatColor.RED + '(' + ClaimableFaction.ENVIRONMENT_MAPPINGS.get(location.getWorld().getEnvironment()) + ", " + location.getBlockX() + " | "
                    + location.getBlockZ() + ')');
        }
