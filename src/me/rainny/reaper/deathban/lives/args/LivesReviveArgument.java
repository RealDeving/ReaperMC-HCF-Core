...
public class LivesReviveArgument extends CommandArgument {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (sender instanceof Player) {
            ...
            sender.sendMessage(ChatColor.GRAY + "You have used a life to revive " + relation.toChatColour() + target.getName() + ChatColor.GRAY + '.');
        } else {
            sender.sendMessage(ChatColor.GRAY + "You have revived " + SettingsYML.ENEMY_COLOUR + target.getName() + ChatColor.GRAY + '.');
        }
