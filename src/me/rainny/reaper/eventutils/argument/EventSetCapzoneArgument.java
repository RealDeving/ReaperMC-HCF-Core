...
import me.rainny.reaper.eventutils.tracker.KothTracker;
...
public class EventSetCapzoneArgument extends CommandArgument {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        sender.sendMessage(ChatColor.GRAY + "Set capture zone " + captureZone.getDisplayName() + ChatColor.GRAY + " for faction " + faction.getName() + ChatColor.GRAY + '.');
        return true;
    }
