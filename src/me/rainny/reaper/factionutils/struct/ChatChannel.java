package me.rainny.reaper.factionutils.struct;
...
public enum ChatChannel {
    ...
    public String getDisplayName() {
        ...
        switch (this) {
        case FACTION:
            prefix = SettingsYML.TEAMMATE_COLOUR.toString();
            break;
        case ALLIANCE:
    ...
    public String getRawFormat(Player player) {
        switch (this) {
        case FACTION:
            return SettingsYML.TEAMMATE_COLOUR + "(" + getDisplayName() + SettingsYML.TEAMMATE_COLOUR + ") " + player.getName() + ChatColor.GRAY + ": " + ChatColor.GRAY + "%2$s";
        case ALLIANCE:
            return SettingsYML.ALLY_COLOUR + "(" + getDisplayName() + SettingsYML.ALLY_COLOUR + ") " + player.getName() + ChatColor.GRAY + ": " + ChatColor.GRAY + "%2$s";
        default:
