...
import me.rainny.reaper.factionutils.type.WarzoneFaction;
...
public class SpawnCannonCommand implements CommandExecutor, TabCompleter {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args[0].equalsIgnoreCase("launch")) {
            ...
            int min = SettingsYML.SPAWN_RADIUS_MAP.get(world.getEnvironment());
            int max = SettingsYML.WARZONE_RADIUS;
    ...
    public void launchPlayer(Player player, Location location) {
        ...
        player.sendMessage(ChatColor.GRAY + "Cannoning to " + ChatColor.GREEN + x + ", " + z + ChatColor.GRAY + '.');
    ...
    public int getMaxCannonDistance(CommandSender sender) {
        int decrement = 50;
        int radius = ((SettingsYML.WARZONE_RADIUS + decrement - 1) / decrement) * decrement;
