...
public class FactionSetDtrArgument extends CommandArgument {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args[1].equalsIgnoreCase("all")) {
            ...
            Command.broadcastCommandMessage(sender, ChatColor.GRAY + "Set DTR of all factions to " + newDTR + '.');
            return true;
        }
        ...
        Command.broadcastCommandMessage(sender, ChatColor.GRAY + "Set DTR of " + faction.getName() + " from " + previousDtr + " to " + newDTR + '.');
        return true;
    }
