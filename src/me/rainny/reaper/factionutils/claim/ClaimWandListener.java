...
import me.rainny.reaper.listener.render.VisualBlock;
    ...
    public void onPlayerInteract(PlayerInteractEvent event) {
        ...
        if (action == Action.LEFT_CLICK_BLOCK || action == Action.RIGHT_CLICK_BLOCK) {
            ...
            if (plugin.getClaimHandler().canClaimHere(player, blockLocation)) {
                ...
                player.sendMessage(ChatColor.GREEN + "You have selected Position " + ChatColor.GRAY + selectionId + ChatColor.GREEN + " at: " + ChatColor.GOLD + '(' + ChatColor.GRAY
                ...
                if (claimSelection.hasBothPositionsSet()) {
                    ...
                    player.sendMessage(ChatColor.AQUA + "The claim costs: " + (selectionPrice > playerFaction.getBalance() ? ChatColor.RED : ChatColor.GREEN) + EconomyManager.ECONOMY_SYMBOL
                            + selectionPrice + ChatColor.AQUA + ". Size: (" + ChatColor.WHITE + claim.getWidth() + ", " + claim.getLength() + ChatColor.AQUA + "), " + ChatColor.WHITE
