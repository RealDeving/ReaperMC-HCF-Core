...
public class FactionAnnouncementArgument extends CommandArgument {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (newAnnouncement == null) {
            playerFaction.broadcast(ChatColor.WHITE + sender.getName() + ChatColor.GRAY + " has cleared the factions' announcement.");
            return true;
        }

        playerFaction.broadcast(ChatColor.WHITE + player.getName() + " has updated the factions' announcement from " + ChatColor.GRAY + (oldAnnouncement != null ? oldAnnouncement : "none")
                + ChatColor.GRAY + " to " + ChatColor.GRAY + newAnnouncement + '.');
