...
public class FactionKickArgument extends CommandArgument {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (playerFaction.removeMember(sender, onlineTarget, targetMember.getUniqueId(), true, true)) {
            ...
            playerFaction.broadcast(SettingsYML.ENEMY_COLOUR + targetMember.getName() + ChatColor.GRAY + " has been kicked by " + SettingsYML.TEAMMATE_COLOUR
                    + playerFaction.getMember(player).getRole().getAstrix() + sender.getName() + ChatColor.GRAY + '.');
        }
